...
<footer class="bg-white mt-12">
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <!-- Contact Information -->
            <div class="space-y-4">
                <h4 class="text-gray-800 font-semibold text-lg">Punya Pertanyaan</h4>
                <div class="space-y-3">
    ...
    <!-- Copyright -->
    <div class="bg-green-600 mt-12">
        <div class="container mx-auto px-6 py-1">
            <p class="text-center text-white text-sm font-bold">
                © {{ date('Y') }}, {{ config('app.name', 'Company') }}. Seluruh Hak Cipta Dilindungi Undang-Undang.
            </p>
        </div>
    </div>
</footer>