...
@section('main')
    <div class="min-h-screen bg-gray-50 py-8">
            ...
            <div class="bg-white rounded-lg shadow-sm p-8">
                ...
                <form action="{{ route('checkout.process') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-8">
                        ...
                        <!-- Info Pembayaran -->
                        <div class="bg-green-50 border border-green-200 rounded-xl p-5 shadow-sm mb-6">
                            ...
                            <div class="space-y-4 text-sm text-gray-700">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="px-2 py-1 rounded bg-white border text-green-700 font-semibold">{{ $paymentAccounts->bank_name }}</span>
                                </div>
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-gray-900 font-medium">{{ $paymentAccounts->account_holder_name }}</span>
                                </div>

                                <!-- No. Rekening dengan fitur copy -->
                                <div>
                                    ...
                                    <button type="button" onclick="copyRekening()"
                                        ...
                                        <span id="rekeningNumber">{{ $paymentAccounts->account_number }}</span>
                                        <svg id="copyIcon" class="w-5 h-5 text-gray-500 group-hover:text-gray-700"
                                            fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                        </svg>
                                    </button>
                                    <p id="copyMsg" class="text-xs text-green-600 mt-1 hidden">Nomor rekening disalin!</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="sender_name" name="sender_name" value="{{ old('sender_name') }}"
                                    class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500 @error('sender_name') border-red-500 @enderror"
                        ...
                        <div class="mb-6">
                            ...
                            <select id="address" name="address"
                                class="block w-full pl-3 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500 @error('address') border-red-500 @enderror"
        ...
        return $item['price'] * $item['quantity']; }, $orderItems ?? []))}}">
                    <div class=" mb-8">
        ...
        return $item['price'] * $item['quantity']; }, $orderItems ?? [])), 0, ',', '.') }}
                                </span>
                            </div>
                        </div>
                    </div>
